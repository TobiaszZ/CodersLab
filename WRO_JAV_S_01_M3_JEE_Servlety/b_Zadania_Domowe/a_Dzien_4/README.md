...
3. Stwórz, w pliku jsp, formularz, który przesyła metodą `POST`. Formularz powinien zawierać:  
...
2. Sprawdź czy data i czas lotu zostały podana.
...
Tutaj znajdziesz przykłądy: [przykład1][date-example1] , [przykład2][date-example2]
